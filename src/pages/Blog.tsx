...
const blogPosts = [
  { slug: "saas-seo-strategy-ecommerce-ai-chatbot", title: "SaaS SEO Strategy for an eCommerce AI Chatbot (2026): The Complete Page Architecture & Content Plan", excerpt: "Most SaaS SEO advice is a checklist — meta titles, sitemaps, backlinks. This is a strategy. Real competitor analysis of Tidio, Gorgias, Rep AI, and Zipchat AI plus the complete page architecture (features, integrations, use cases, industries, comparison vs alternatives, glossary, free tools) that produces 116+ targeted landing pages from a single SaaS product.", author: "Naveed Ganatra", date: "2026-03-18", readTime: "14 min read", category: "SaaS SEO Strategy" },
  { slug: "google-search-console-ai-tool", title: "Google Search Console AI Tool Explained (2026) | New AI Feature for SEO Analysis & GSC Reports", excerpt: "Google Search Console now has an AI-powered configuration tool that lets you generate reports with natural language prompts instead of manual filters. Learn how it works — custom date ranges, period comparisons, CTR breakdowns — plus the current limitations every SEO professional should know.", author: "Naveed Ganatra", date: "2026-03-10", readTime: "8 min read", category: "Google Search Console" },
  { slug: "dark-seo-funnel-explained", title: "Dark SEO Funnel Explained: Why Traffic No Longer Proves SEO Success in 2026", excerpt: "Traffic is no longer the proof of SEO success. The Dark SEO Funnel reveals how AI discovery drives branded search and revenue without traditional clicks — and 84% of B2B buyers now discover vendors through AI first. Learn the 3-stage funnel flow, the 5 metrics that replace traffic, and how to optimize for invisible AI discovery.", author: "Naveed Ganatra", date: "2026-03-02", readTime: "11 min read", category: "AI & SEO Strategy" },
