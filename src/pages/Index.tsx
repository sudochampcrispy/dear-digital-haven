...
const blogPosts = [
  { title: "SaaS SEO Strategy for an eCommerce AI Chatbot (2026)", link: "/blog/saas-seo-strategy-ecommerce-ai-chatbot", desc: "Most SaaS SEO advice is a checklist. This is a strategy. Real competitor analysis of Tidio, Gorgias, Rep AI, and Zipchat AI plus the full page architecture that produces 116+ targeted landing pages from one SaaS product.", category: "SaaS SEO Strategy", date: "Mar 18, 2026", readTime: "14 min", videoId: "iyq5lKiqyyI", videoType: "long" as const },
  { title: "Google Search Console AI Tool Explained (2026)", link: "/blog/google-search-console-ai-tool", desc: "Google Search Console now has an AI-powered tool that generates reports with natural language prompts. No more manual filters — one prompt, one report, instantly exported.", category: "Google Search Console", date: "Mar 10, 2026", readTime: "8 min", videoId: "-7Bnab8I0g8", videoType: "long" as const },
