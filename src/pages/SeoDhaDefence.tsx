        ...
        <div className="section-container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            {[
              ...
              { title: "Private Schools & Tutoring", desc: "Parents in DHA actively search for schools, O/A-level academies, and private tutors by phase. Education-focused content captures these high-intent family searches." },
