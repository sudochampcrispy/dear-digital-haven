...
const serviceCategories = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/construction-company-seo", label: "Construction SEO" },
      { href: "/logistics-company-seo", label: "Logistics SEO" },
      { href: "/textile-company-seo", label: "Textile Company SEO" },
      { href: "/export-company-seo", label: "Export Company SEO" },
      { href: "/cybersecurity-company-seo", label: "Cybersecurity SEO" },
      { href: "/ai-company-seo", label: "AI Company SEO" },
      { href: "/fintech-company-seo", label: "Fintech SEO" },
      { href: "/cloud-services-company-seo", label: "Cloud Services SEO" },
      { href: "/oil-gas-services-seo", label: "Oil & Gas SEO" },
    ],
  },
  {
    label: "Locations",
