...
const SiteFooter = () => (
  <footer className="border-t surface-sunken">
    ...
    <div className="section-container pt-12 pb-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-8 border-b">
        <div>
          ...
          <p className="text-sm text-body max-w-md mt-1">
            Google-certified SEO expert in Karachi — 10+ years delivering measurable organic growth across 27+ industries.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-4 text-sm">
          ...
          <a href="https://wa.me/923232877850" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 font-medium transition-colors">WhatsApp →</a>
        </div>
      </div>
    </div>
      ...
      <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
        ...
        <nav aria-label="SEO Services">
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/seo-services" className="text-subtle hover:text-foreground transition-colors">All SEO Services</Link></li>
            ...
            <li><Link to="/ai-search-optimization" className="text-subtle hover:text-foreground transition-colors">AI Search (GEO)</Link></li>
        ...
        {/* Specialized */}
        <nav aria-label="Specialized SEO">
          <p className="text-sm font-semibold text-heading mb-3">Specialized</p>
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/website-migration-seo" className="text-subtle hover:text-foreground transition-colors">Migration SEO</Link></li>
            <li><Link to="/ecommerce-seo-karachi" className="text-subtle hover:text-foreground transition-colors">E-commerce Karachi</Link></li>
            <li><Link to="/shopify-ecommerce-seo" className="text-subtle hover:text-foreground transition-colors">Shopify E-commerce</Link></li>
        ...
        <nav aria-label="Company">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="https://www.youtube.com/@naveedganatra" target="_blank" rel="noopener noreferrer" className="text-subtle hover:text-foreground transition-colors">YouTube</a></li>
            <li><a href="https://pk.linkedin.com/in/naveed-ganatra-search-engine-optimization-specialist" target="_blank" rel="noopener noreferrer" className="text-subtle hover:text-foreground transition-colors">LinkedIn</a></li>
            <li><a href="https://proseotoolkit.com" target="_blank" rel="noopener noreferrer" className="text-subtle hover:text-foreground transition-colors">ProSEOToolkit</a></li>
          </ul>
        </nav>
        ...
        <nav aria-label="Locations">
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/seo-agency-karachi" className="text-subtle hover:text-foreground transition-colors">SEO Karachi</Link></li>
            <li><Link to="/seo-agency-lahore" className="text-subtle hover:text-foreground transition-colors">SEO Lahore</Link></li>
            <li><Link to="/seo-agency-islamabad" className="text-subtle hover:text-foreground transition-colors">SEO Islamabad</Link></li>
            <li><Link to="/seo-agency-rawalpindi" className="text-subtle hover:text-foreground transition-colors">SEO Rawalpindi</Link></li>
            <li><Link to="/seo-agency-faisalabad" className="text-subtle hover:text-foreground transition-colors">SEO Faisalabad</Link></li>
            <li><Link to="/seo-agency-multan" className="text-subtle hover:text-foreground transition-colors">SEO Multan</Link></li>
            <li><Link to="/seo-agency-gujranwala" className="text-subtle hover:text-foreground transition-colors">SEO Gujranwala</Link></li>
            <li><Link to="/seo-agency-hyderabad" className="text-subtle hover:text-foreground transition-colors">SEO Hyderabad</Link></li>
            <li><Link to="/seo-agency-peshawar" className="text-subtle hover:text-foreground transition-colors">SEO Peshawar</Link></li>
            <li><Link to="/seo-agency-quetta" className="text-subtle hover:text-foreground transition-colors">SEO Quetta</Link></li>
          </ul>
        </nav>
      </div>
    </div>
    ...
    {/* Copyright */}
    <div className="section-container pb-8 pt-4 border-t text-center text-xs text-subtle">
